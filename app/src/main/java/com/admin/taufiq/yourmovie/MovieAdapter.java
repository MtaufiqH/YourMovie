...
public class MovieAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.textViewMovieTitle =(TextView)convertView.findViewById(R.id.movie_title);
            holder.textViewMovieDesc =(TextView)convertView.findViewById(R.id.movie_description);
            holder.textViewMovieDate =(TextView)convertView.findViewById(R.id.movie_date);
            Glide.with(aContext).load("http://image.tmdb.org/t/p/w185/"
                    + movieData.get(position).getMovieImage()).into(holder.movie_poster);
